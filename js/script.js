...
document.addEventListener('DOMContentLoaded', function () {
    ...
    if (preloader) {
        // Match the line width to the rendered width of the name text
        const preloaderName = preloader.querySelector('.preloader-name');
        const preloaderLine = preloader.querySelector('.preloader-line');
        if (preloaderName && preloaderLine) {
            preloaderLine.style.width = preloaderName.offsetWidth + 'px';
        }
      
        document.documentElement.style.overflow = 'hidden';
        document.querySelectorAll('section').forEach(s => s.classList.remove('fade-in'));
        setTimeout(() => {
...
// Generic helper to open WhatsApp with prefilled text
